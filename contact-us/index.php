<?php 
    ...
    include "../db/contact_message.php";
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="msmnav" id="sbmndiv">
                                <li><a href="../services/vacuum-repairing/">Vacuum Repairing</a></li>
                                <li><a href="../services/microwave-repairing/">Microwave Repairing</a></li>
                            </ul>
                        </li>
        ...
        <div class="row headerpding"  id="myDiv">
            <div class="col-4 theres">
                ...
                <div class="text-center fsdfasd">
                    ...
                    <a href="../"><img src="../images/logo/logo.webp" id="imglogo" /></a>
            ...
            <div class="col-8">
                    ...
                    <ul class="headermenus">
                        <li><a href="../" style="color:#3d3da8;">Home</a></li>
                        <li id="submenudivv" >

                            <i class="fa fa-angle-right" aria-hidden="true"></i>

                            <a href="../services/" class="headerspeccolor">
                                &nbsp;&nbsp;Services
                            </a>
                        </li>
                    ...
                    <div class="submenuheader">
                        ...
                        <ul>
                            <li id="menusinnn"><a href="../services/vacuum-repairing/" id="hoveron">Vacuum Repairing</a></li>
                            <li id="menusinnn2"><a href="../services/microwave-repairing/" id="hoveron2">Microwave Repairing</a></li>
                        </ul>
    ...
    <!--Footer Start-->
        ...
        <div class="row ftrclrb">
            ...
            <span class="bsicclr">Quick Links</span>
                ...
                <div class="ftrbascvxk">
                    <a href="../services/vacuum-repairing/">
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                        &nbsp;&nbsp;&nbsp;Vacuum Repairing
                    </a>
                </div>
                ...
                <div class="ftrbascvxkfsad">
                    <a href="../services/microwave-repairing/">
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                        &nbsp;&nbsp;&nbsp;Microwave Repairing
                    </a>
                </div>
